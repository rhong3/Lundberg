...
for (can in cancerss){
  ...
  pp = pheatmap(matt.prot, show_rownames=FALSE, show_colnames=FALSE, main=paste(can[1], ' proteomics Spearman correlation ALL', sep=''))
  pt = pheatmap(matt.trans, show_rownames=FALSE, show_colnames=FALSE, main=paste(can[1], ' transcriptomics Spearman correlation ALL', sep=''))
  ...
  matt.prot[is.na(matt.prot)] <- 0
  matt.trans[is.na(matt.trans)] <- 0
  pp = pheatmap(matt.prot, show_rownames=FALSE, show_colnames=FALSE, main=paste(can[1], ' proteomics Spearman correlation nontranscript', sep=''))
  pt = pheatmap(matt.trans, show_rownames=FALSE, show_colnames=FALSE, main=paste(can[1], ' transcriptomics Spearman correlation nontranscript', sep=''))
  ...
  matt.prot[is.na(matt.prot)] <- 0
  matt.trans[is.na(matt.trans)] <- 0
  pp = pheatmap(matt.prot, show_rownames=FALSE, show_colnames=FALSE, main=paste(can[1], ' proteomics Spearman correlation transcript', sep=''))
  pt = pheatmap(matt.trans, show_rownames=FALSE, show_colnames=FALSE, main=paste(can[1], ' transcriptomics Spearman correlation transcript', sep=''))
