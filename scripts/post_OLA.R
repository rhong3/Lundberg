...
for (i in c('non-Endometrioid', 'Serous')){
  ola = read_csv(paste("Results/OLA/UCEC_subtype/", i, ".outlier_sites_in_", i, ".txt", sep=''), col_names = FALSE)
  ola$group = i
...
write_csv(summ, 'Results/OLA/UCEC_subtype/summary.csv')
